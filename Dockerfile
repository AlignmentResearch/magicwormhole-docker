# Based off of https://hub.docker.com/r/magicwormhole/magic-wormhole/dockerfile
...
# being retrieved.
ENV SECURITY_UPDATES="2022-10-10"
...
# Source repositories seem to be disabled on the Jammy image now.  Enable
...
# TODO(adam): disabled as we need root access for accessing external volume
# USER 1000
